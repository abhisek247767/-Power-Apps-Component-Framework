...
export class DemoTeste implements ComponentFramework.StandardControl<IInputs, IOutputs> {

    /**
     * Empty constructor.
     */
    private glowingText: HTMLDivElement;
    ...
    this.glowingText.className = "classDemo";

    if(context.parameters.sampleProperty.raw){
    // Set inner HTML content
    this.glowingText.innerHTML =context.parameters.sampleProperty.raw;
    }

    if (context.parameters.TextColor.raw) {
        // Apply bold style based on the TextBold parameter
